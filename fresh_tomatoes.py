...
<script src=
"https://code.jquery.com/jquery-1.10.1.min.js"></script>
<script src=
"https://netdna.bootstrapcdn.com/bootstrap/3.1.0/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on('click', '.movie-tile', function (event) {
            ...
            $("#movie-overview-text").empty().append("<p align='justify'>" +
            movieOverviewText + "</p>");
        });
    ...
    <div class="modal" id="trailer">
      <div class="modal-dialog">
        <div class="modal-content">
          <a href="#" class="hanging-close" data-dismiss=
...
movie_tile_content = '''
<div class="col-md-6 col-lg-4 movie-tile text-center" movie-overview=
"{movie_overview}" data-trailer-youtube-id=
